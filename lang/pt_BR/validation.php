...
return [
    ...
    'confirmed'            => 'A confirmação de senha não confere. Verifique se digitou a mesma senha nos dois campos.',
    ...
    'custom' => [
        ...
        'username' => [
            'unique'     => 'Este login já está em uso. Escolha outro.',
            'alpha_dash' => 'O login deve conter apenas letras, números, hífen ou underscore (sem espaços).',
        ],
        'cpf' => [
    ...
    'attributes' => [
        ...
        'valor'                 => 'valor',
        'data'                  => 'data',
        'data_lembrete'         => 'data do lembrete',
        'data_pagamento'        => 'data de pagamento',
        'servico_nome'          => 'descrição do serviço',
